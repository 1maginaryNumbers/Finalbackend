...
exports.createPayment = async (req, res) => {
  try {
    ...
    const frontendUrl = process.env.FRONTEND_PUBLIC_URL || process.env.PUBLIC_URL || 'https://bdctemple.vercel.app';
    ...
    if (frontendUrl) {
      parameter.callbacks = {
        finish: `${frontendUrl}/paket-sumbangan?payment=success`,
        unfinish: `${frontendUrl}/paket-sumbangan?payment=pending`,
        error: `${frontendUrl}/paket-sumbangan?payment=error`
      };
    }
